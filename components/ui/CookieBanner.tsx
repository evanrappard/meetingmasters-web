...
const T = {
  nl: {
    ...
    tekst:
      "Een deel van de cookies is nodig om de site en onze formulieren te laten werken. Geef je ook toestemming voor statistieken en marketing, dan leren we wat werkt en maken we de site beter. Meer in onze ",
  ...
  en: {
    ...
    tekst:
      "Some cookies are needed to make the site and our forms work. Give us permission for statistics and marketing as well, and we learn what works and make the site better. More in our ",
