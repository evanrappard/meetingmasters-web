...
/** De crème en het goud komen van de oude pagina, met de pipet nagemeten. */
const CREME = "#F4F1E7";
const GOUD = "#D69322";
...
const TEKST = {
  nl: {
    ...
    nodigKop: "Dit heb je nodig voor de beste ervaring:",
    punten: [
  ...
  en: {
    ...
    nodigKop: "This is what you need for the best experience:",
    punten: [
