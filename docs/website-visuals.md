...
|---|---|---|---|
| Hero (achtergrondvideo) | `/videos/hero-boomerang.mp4` | LOKAAL | `Downloads/welcome hero stock.mp4` → 1080p, **20% vertraagd** (`setpts=1.25*PTS`), boomerang, CRF 25, ~2,5 MB. Plain `<video autoplay muted loop playsinline>`, meteen instarten. **Uitsnede** `object-position: center 82%` (24 aug 2026, was 38% — beeld omhoog zodat de bubbels ruimer in beeld staan, keuze van Emilie uit een schuifproef); geldt ook voor de posters |
