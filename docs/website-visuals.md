...
| `/nl/games-tools/ravenhack` | hero `/images/ravenhack-hero-v4.webp` (28 aug 2026 — **gewisseld met stap 2 van Hoe-het-werkt**, op verzoek. Bron `Downloads/UK Designs Escape (1).png` 3200×1800, **gespiegeld**: het silhouet stond links, precies waar de hero-tekst staat. In die bron staat de tekst "Need a hint?", die gespiegeld achterstevoren zou lezen; weggewerkt met een stuk uit de schone 900px-versie (`ravenhack-onderzoek.webp`), opgeschaald en met zachte rand ingezet. Dat vlak ligt in de hero achter de kop, onder het verloop. Opgeslagen op 2560 breed, kwaliteit 86; het beeld toont op quality 90 via next/image); Hoe-het-werkt stappen `ravenhack-crisis-v2.webp` (play-knop uit het beeld gepoetst met een lap uit een egaal stuk ernaast) / stap 2 = `ravenhack-hero-v3.webp` (de oude hero, `Downloads/Erik_en_Dave_HSZ_scherper.png`, 2338×1212) / `ravenhack-doorbraak.webp` (`UK Designs Escape (2)`); videoblok = YouTube-facade, NL `k8fXvDLmXtg` + poster `ravenhack-video-poster-nl.webp`, EN `_y8yi-YgEhk` + poster `ravenhack-video-poster-en.webp` (posterbeeld = frame 300 uit de bronvideo's in OneDrive, `Wat is RavenHack.mp4` / `What is RavenHack EN.mp4`). **Let op:** stap 2 en het posterbeeld tonen sinds de wissel allebei de High Security Zone — twee sterk gelijkende beelden op één pagina. Niet meer in gebruik: `ravenhack-hero.webp`, `ravenhack-onderzoek.webp` (de schone 900px-versie, nu alleen nog als lapmateriaal), `ravenhack-crisis.webp`, `ravenhack-video-poster.jpg` en de oude trailer `5g3Vv51_hR0` | LOKAAL + YouTube |
