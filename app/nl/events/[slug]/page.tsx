...
const EVENT_DATA: Record<string, EventData> = {
  ...
  ontwikkeltraject: {
    ...
    faq: [
      { q: "Hoe verschilt een online training van een webinar?", a: "Een webinar draait meestal om kennisoverdracht. Een online training vraagt actieve deelname. Deelnemers oefenen, reflecteren, werken samen en passen het geleerde direct toe. Juist daardoor blijft kennis beter hangen. Wie een interactieve online training wil geven, heeft daarom meer nodig dan alleen een presentatie en een camera." },
      { q: "Kan iedere training online worden gegeven?", a: "Bijna iedere training kan online worden gegeven. Wel vraagt een digitale training vaak om een andere opzet. Wat in een fysieke zaal werkt, werkt online niet automatisch. Daarom helpen wij trainers en opleiders om bestaande trainingen te vertalen naar een effectieve online leerervaring." },
      { q: "Hoe houden jullie deelnemers actief betrokken?", a: "Door deelnemers niet alleen te laten luisteren, maar vooral te laten doen. Denk aan oefeningen, breakoutgesprekken, interactieve opdrachten, reflectievragen en gezamenlijke werkvormen. Mensen leren nu eenmaal meer van deelname dan van observatie. Dat geldt voor een korte online workshop én voor een uitgebreid online leertraject." },
      { q: "Welke software gebruiken jullie?", a: "We hebben ervaring met Zoom, Teams, Zoom Events, SpatialChat, Miro en verschillende leer- en interactietools. Welke omgeving het beste werkt, hangt af van het leerdoel, de groepsgrootte en de gewenste leerervaring. De techniek ondersteunt de training, niet andersom." },
      { q: "Voor hoeveel deelnemers is een online training geschikt?", a: "Dat varieert van kleine groepen van zes deelnemers tot grotere leerprogramma's met honderd deelnemers of meer. De ideale groepsgrootte hangt af van de mate van interactie en begeleiding." },
      { q: "Wat kost een online training of workshop?", a: "Dat hangt af van de groepsgrootte, de duur van het programma, de voorbereiding en de gewenste ondersteuning. Daarom maken wij altijd een voorstel op maat." },
    ],
    faqMore: [
      ...
      { q: "Hoe voorkom je Zoom-moeheid tijdens een training?", a: "Door afwisseling aan te brengen. Korte blokken, actieve werkvormen, beweging, reflectie en samenwerking zorgen ervoor dat deelnemers betrokken blijven en energie houden." },
      ...
      { q: "Kunnen deelnemers tussen sessies opdrachten maken?", a: "Ja. Sterker nog: veel succesvolle leertrajecten combineren live sessies met opdrachten tussen de bijeenkomsten. Daardoor wordt leren onderdeel van het dagelijkse werk." },
      { q: "Kunnen jullie trainers begeleiden?", a: "Ja. Sommige opdrachtgevers verzorgen zelf de inhoud en schakelen ons in voor het ontwerp, de interactie en de technische begeleiding. Zo kunnen trainers zich volledig richten op hun expertise." },
      { q: "Wat maakt een online training succesvol?", a: "Een succesvolle online training begint niet bij de techniek, maar bij het leerdoel. De beste trainingen combineren duidelijke leerdoelen, actieve werkvormen, interactie en voldoende ruimte voor toepassing in de praktijk." },
      { q: "Kunnen jullie ook langere leertrajecten begeleiden?", a: "Ja. We ondersteunen regelmatig online leertrajecten die bestaan uit meerdere trainingsdagen, workshops, intervisiesessies of leergemeenschappen. Daarbij helpen we niet alleen met de techniek, maar ook met het ontwerp van de leerervaring." },
      { q: "Wat is het verschil tussen een online workshop en een online training?", a: "Een workshop is meestal korter en meer gericht op samen verkennen, creëren of oefenen. Een training heeft vaak een duidelijk leerdoel en een meer gestructureerde opbouw. In de praktijk lopen beide vormen regelmatig in elkaar over." },
      { q: "Waarom kiezen trainers voor MeetingMasters?", a: "Omdat wij begrijpen dat online trainen iets anders vraagt dan een fysieke training kopiëren naar Zoom. Wij helpen trainers, opleiders en L&D-teams om hun expertise te vertalen naar interactieve online trainingen en workshops waarin deelnemers actief betrokken blijven en daadwerkelijk leren." },
    ],
  },
