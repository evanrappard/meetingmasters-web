...
interface EventData {
  ...
  cases?: { label: string; title: string; body: string; img?: string; imgStyle?: React.CSSProperties }[];
...
const EVENT_DATA: Record<string, EventData> = {
  ...
  "all-hands": {
    ...
    cases: [{ label: "Internationaal MKB", title: "Nieuwe koers voor alle medewerkers", body: "Deze organisatie wil de jaarlijkse all-hands ditmaal online houden. Deelnemers komen uit alle landen. Wij maken een online all-hands met managementupdates, teamverhalen en een brede vragenronde. Een sessie voor richting en herkenning.", img: "/images/events-allhands-koers.webp" }, { label: "HR en communicatie", title: "Diversity Day", body: "Voor de jaarlijkse Diversity Day ontwerpen we een bijeenkomst met experts en interne medewerkers. Naast presentaties is er een virtuele marktplaats waar deelnemers doorpraten over onderwerpen die voor hen relevant zijn.", img: "/images/events-allhands-diversity.webp" }, { label: "Middelgroot Nederlands bedrijf", title: "Maandelijkse all-hands met vaste opbouw", body: "Wij helpen een terugkerend format neerzetten voor organisatiebrede updates voor medewerkers die over het hele land zitten. Met een herkenbare structuur en goed planbare voorbereiding wordt het een vast ankerpunt.", img: "/images/events-allhands-terugkerend.webp" }],
