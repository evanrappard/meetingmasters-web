...
const EVENT_DATA: Record<string, EventData> = {
  "strategiedagen": {
    ...
    steps: [{ title: "Intake", body: "We leren uw organisatie, uw groep en het vraagstuk kennen." }, { title: "Ontwerp", body: "Agenda, plenaire sessies, breakouts en besluitvormingsmomenten op maat." }, { title: "Repetitie", body: "Technische doorloop met sprekers, hosts en stakeholders." }, { title: "Live productie", body: "Volledig begeleid: techniek én inhoudelijke facilitatie." }],
  ...
  "all-hands": {
    ...
    cases: [{ label: "Internationale NGO", title: "Nieuwe koers voor alle medewerkers", body: "Deze organisatie wil de jaarlijkse all-hands ditmaal online houden. Deelnemers komen uit alle landen. Wij maken een online all-hands met managementupdates, teamverhalen en een brede vragenronde. Een sessie voor richting en herkenning.", img: "/images/events-bijeenkomst.webp" }, { label: "HR en communicatie", title: "Diversity Day", body: "Voor de jaarlijkse Diversity Day ontwerpen we een bijeenkomst met experts en interne medewerkers. Naast presentaties is er een virtuele marktplaats waar deelnemers doorpraten over onderwerpen die voor hen relevant zijn.", img: "/images/events-bijeenkomst.webp" }, { label: "Middelgroot Nederlands bedrijf", title: "Maandelijkse all-hands met vaste opbouw", body: "Wij helpen een terugkerend format neerzetten voor organisatiebrede updates voor medewerkers die over het hele land zitten. Met een herkenbare structuur en goed planbare voorbereiding wordt het een vast ankerpunt.", img: "/images/events-bijeenkomst.webp" }],
  ...
  "team-ontwikkeling": {
    ...
    related: ["ontwikkeltraject", "onboardingdag", "brainstormen", "teamuitje"],
    validation: {
  ...
  "bedrijfsfeest": {
    ...
    outcomes: [{ title: "Echte verbinding", body: "Geen awkward Zoom-borrel maar een avond die mensen écht bijblijft en waar ze naar uitkijken." }, { title: "Passend bij uw cultuur", body: "Het feest voelt als uw organisatie — de juiste sfeer, het juiste niveau, het juiste gezelschap." }, { title: "Een waardige afsluiter", body: "Of het nu een mijlpaal of een jaarlijkse traditie is — het moment krijgt de aandacht die het verdient." }],
    forWho: "Teams, afdelingen, hele organisaties",
    range: "20-400 deelnemers",
    steps: [{ title: "Intake", body: "Sfeer, schaal en wensen — wat past bij uw organisatie?" }, { title: "Ontwerp", body: "Programma, games, entertainment en sociale ruimtes." }, { title: "Repetitie", body: "Alles staat klaar, hosts zijn ingespeeld." }, { title: "Live productie", body: "Wij runnen het feest volledig zodat u zelf ook kunt genieten." }],
  ...
  "kerstfeest": {
    ...
    outcomes: [{ title: "Echte gezelligheid", body: "Geen verplicht nummertje maar een avond die mensen écht leuk vinden en lang navertellen." }, { title: "Passend bij uw organisatie", body: "De sfeer, het niveau en het programma passen bij wie u bent als bedrijf." }, { title: "Een memorabel einde van het jaar", body: "Een waardige afsluiter die mensen laat voelen dat ze gewaardeerd worden." }],
    forWho: "Teams, afdelingen, hele organisaties",
    range: "10-500 deelnemers",
    steps: [{ title: "Intake", body: "Sfeer, schaal en wensen — wat past bij uw organisatie en cultuur?" }, { title: "Ontwerp", body: "Programma met games, entertainment, sociale ruimtes en surprises." }, { title: "Repetitie", body: "Alles staat klaar, hosts zijn ingespeeld op de avond." }, { title: "Live productie", body: "Wij runnen het feest volledig zodat u ook zelf kunt genieten." }],
    related: ["bedrijfsfeest", "teamuitje", "community-building", "team-ontwikkeling"],
    validation: {
    ...
    faqMore: [{ q: "Welke software gebruiken jullie?", a: "Bij dit soort sessies geven wij de voorkeur aan een vernieuwend platform waar gesprekken en samenwerking makkelijker gaan. SpatialChat werkt bijzonder goed. U kunt gewoon een demo boeken om dat een keer te ervaren." }, { q: "Kunnen internationale teams deelnemen?", a: "Ja. Dat gebeurt regelmatig." }, { q: "Kunnen we het feest volledig personaliseren?", a: "Ja. We verwerken graag thema's, verhalen en elementen uit de organisatie." }, { q: "Zijn er activiteiten rondom teambuilding mogelijk?", a: "Ja. Veel organisaties combineren ontspanning met samenwerking en ontmoeting." }, { q: "Kunnen deelnemers vrij rondlopen en mensen ontmoeten?", a: "Ja. In interactieve omgevingen kunnen deelnemers zelf bepalen met wie zij in gesprek gaan." }, { q: "Wat maakt een online kerstfeest succesvol?", a: "Een goede balans tussen programma, ontmoeting en ruimte voor spontane gesprekken." }],
  ...
  "teamuitje": {
    ...
    intro:
      "Een online teamuitje is geen digitale versie van de vrijdagmiddagborrel. Wij ontwerpen online teamuitjes en online bedrijfsuitjes waarin mensen spelen, praten en samenwerken in een omgeving die uitnodigt tot contact. Van quiz tot escape challenge, van creatieve opdracht tot informele netwerkruimte: het programma past bij uw team, uw doel en de gewenste energie.",
  ...
  "community-building": {
    ...
    outcomeSummary: "Voor leden, alumni en netwerken die elkaar online vaker en beter willen ontmoeten.",
  },
  ...
  "focusgroep": {
    ...
    intro:
      "Een focusgroep geeft inzicht in de belevingswereld van uw doelgroep - hun motieven, twijfels en wensen. Wij ontwerpen en faciliteren innovatieve online focusgroepen waarbij deelnemers zich vrijer voelen om eerlijk te zijn en onderzoekers bruikbare inzichten krijgen.",
    outcomes: [{ title: "Diepgaand inzicht", body: "U leert wat uw doelgroep écht drijft, twijfelt en wil — niet wat ze zeggen te willen." }, { title: "Rijke kwalitatieve data", body: "Inzichten die uw kwantitatief onderzoek aanvullen en verdiepen." }, { title: "Directe toepasbaarheid", body: "Heldere conclusies die u direct kunt gebruiken voor beleid, product of communicatie." }],
  ...
  "conferentie": {
    ...
    steps: [{ title: "Intake", body: "Programma, sprekers, sessiestructuur en technische eisen." }, { title: "Ontwerp", body: "Platform, plenaire + parallelle sessies, netwerkmomenten." }, { title: "Repetitie", body: "Volledige technische doorloop met alle sprekers en hosts." }, { title: "Live productie", body: "Professionele productie van begin tot eind." }],
  ...
  "netwerkevent": {
    ...
    steps: [{ title: "Intake", body: "Doelgroep, doel van het netwerken en gewenste sfeer." }, { title: "Ontwerp", body: "Matchmaking-structuur, gespreksformats en platform-keuze." }, { title: "Repetitie", body: "Technische doorloop met hosts en moderatoren." }, { title: "Live productie", body: "Volledig begeleid — ook de informele momenten." }],
