      ...
      <section className="bg-[#2D2D2D] py-20 md:py-28">
        <div className="max-w-content mx-auto px-8 md:px-16 lg:px-20">
          <div className="max-w-[640px]">
            <p className="text-[#EEBE3D] text-[10px] font-bold tracking-[0.2em] uppercase mb-6">Technologie</p>
            <h1
      ...
      <section className="bg-white py-16 md:py-20">
        <div className="max-w-content mx-auto px-8 md:px-16 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { href: "/nl/technologie/spatialchat", label: "SpatialChat", desc: "Wat het platform is, hoe het werkt en waarom wij het kiezen.", accent: true },
              { href: "/nl/technologie/hoe-het-werkt", label: "Hoe het werkt", desc: "Instructies voor deelnemers en organisatoren.", accent: false },
              { href: "/nl/technologie/faq", label: "FAQ", desc: "Veelgestelde vragen over platforms, events en virtual offices.", accent: false },
              { href: "/nl/technologie/helpdesk", label: "Helpdesk", desc: "Iets werkt niet? Direct zelf oplossen tijdens uw meeting.", accent: false },
            ].map((item) => (
