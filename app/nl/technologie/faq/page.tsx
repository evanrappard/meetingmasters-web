...
export const metadata: Metadata = {
  ...
  description:
    "Loopt er iets vast tijdens je online bijeenkomst? Vind hier snel en helder het antwoord — per platform (SpatialChat, Zoom, Zoom Events, Teams) en per probleem: link, geluid, beeld of overig.",
};

const SUPPORT = "+31 6 33 03 47 07";

const CATEGORIES: FaqCategory[] = [
  { id: "link", label: "Ik kan de link niet vinden", icon: "🔑", intro: "Bijna altijd staat de link in je uitnodigingsmail — kijk ook even in je spam. Kom je er niet uit bij een begeleide bijeenkomst? Bel ons direct." },
  ...
  { id: "video", label: "Problemen met beeld", icon: "📷", intro: "Ik zie niets, of de anderen zien mij niet. Vaak los je het op met de juiste camera of door toestemming te geven in de browser." },
...
const DATA: Record<string, ToolBlock> = {
  Algemeen: {
    link: [
      ...
      { q: "Ik krijg een melding of foutmelding als ik wil binnenkomen.", a: "Lees rustig wat er staat en volg de knop die wordt aangeboden (bijvoorbeeld 'toestaan' of 'openen'). Helpt dat niet? Sluit het venster, klik opnieuw op de link uit de mail, of probeer een andere browser. Kom je er niet uit, bel dan " + SUPPORT + "." },
      { q: "Het lukt echt niet en het is een begeleide MeetingMasters-bijeenkomst.", a: "Dan helpen we je persoonlijk. Bel gerust " + SUPPORT + ", dan lossen we het samen op. Je bent niet de enige die dit overkomt — we zijn het gewend." },
    ],
    audio: [
    ...
    overig: [
      ...
      { q: "Niets werkt en ik raak in paniek.", a: "Adem even rustig, we lossen dit samen op. Bij een begeleide MeetingMasters-bijeenkomst bel je " + SUPPORT + ", dan helpen we je meteen verder. Je hoeft dit niet alleen op te lossen." },
    ],
  },

  SpatialChat: {
    link: [
      { q: "Ik kan mijn uitnodigingslink niet vinden. Wat nu?", a: "Geen paniek. Kijk in de mail of agenda-uitnodiging van de organisator, ook in je spam- of ongewenste-mailmap. Vind je hem echt niet? Bel ons even op " + SUPPORT + ", dan sturen we je de link opnieuw. We zijn een half uur voor aanvang telefonisch bereikbaar." },
      { q: "Ik heb de link, maar er gebeurt niets als ik erop klik.", a: "Kopieer de hele link en plak hem handmatig in de adresbalk van je browser (bij voorkeur Chrome, Firefox of Edge) en druk op Enter. SpatialChat opent dan vanzelf — downloaden hoeft niet. Lukt het nog niet? Bel " + SUPPORT + "." },
    ...
    overig: [
      ...
      { q: "Ik zit op een werk- of bedrijfsnetwerk en de verbinding hapert.", a: "Sommige zakelijke netwerken blokkeren video- en audioverkeer (WebRTC). Probeer eventueel een ander netwerk of je mobiele hotspot. Blijft het haperen, bel dan " + SUPPORT + ", dan geven we je (of je IT-afdeling) de precieze technische gegevens die nodig zijn." },
    ],
  },

  "Zoom Events": {
    link: [
      { q: "Ik heb geen registratie- of join-mail ontvangen. Wat nu?", a: "Geen paniek. Kijk eerst even in je spam- of ongewenste-mailmap; de mail zit daar vaak. Verplaats hem naar je inbox en de link werkt gewoon. Vind je niets? Bel of app ons op " + SUPPORT + ", dan sturen wij je meteen een persoonlijke join-link." },
      { q: "Ik heb wel geregistreerd maar krijg geen enkele Zoom-mail.", a: "Dat lossen we snel op. Maak een gratis Zoom-account aan met hetzelfde e-mailadres waarmee je je hebt aangemeld, of neem contact met ons op via " + SUPPORT + ". Wij sturen je dan direct je persoonlijke join-link toe zodat je alsnog binnenkomt." },
      { q: "Mijn join-link werkt niet of ik kom er niet mee in.", a: "Controleer of je bent aangemeld met hetzelfde e-mailadres als bij registratie; daar wordt je toegang aan gekoppeld. Lukt het nog niet, bel ons op " + SUPPORT + ". We kunnen je dan handmatig op de lijst zetten of een verse link geven." },
    ],
    audio: [
    ...
    overig: [
      ...
      { q: "Ik kom helemaal niet in het event of de meeting.", a: "Vrijwel elke browser werkt; op een Chromebook kun je het beste de Zoom-webapp gebruiken. Ben je spreker? Doe dan mee via de Zoom-app. Kom je er niet uit, bel ons gerust op " + SUPPORT + "." },
    ],
  },

  Zoom: {
    link: [
      { q: "Ik kan de link niet vinden.", a: "Zoek in je e-mail op 'Zoom' of 'uitnodiging' en check ook je spam- of ongewenste map. In de mail staat een blauwe link of een adres dat begint met zoom.us; klik daarop. Lukt het niet? Bel ons even op " + SUPPORT + ", dan sturen we de link opnieuw." },
      { q: "Er wordt om een wachtwoord of code gevraagd.", a: "Geen paniek: die 'passcode' staat gewoon onderaan dezelfde uitnodigingsmail. Kopieer of typ hem over. Kom je er niet uit, bel dan " + SUPPORT + "." },
    ...
    overig: [
      ...
      { q: "Zoom valt weg of ik ben eruit gevlogen.", a: "Blijf rustig: klik gewoon opnieuw op de uitnodigingslink om terug te komen. Blijft het misgaan, herstart dan Zoom of je apparaat. Tijdens onze begeleide bijeenkomsten kun je altijd bellen met " + SUPPORT + ", dan helpen we je meteen weer online." },
    ],
  },

  "Microsoft Teams": {
    link: [
      { q: "Ik kan de link naar de meeting niet vinden. Wat nu?", a: "Rustig blijven. Kijk eerst in de e-mailuitnodiging en in je agenda-afspraak: de knop 'Deelnemen aan de vergadering' of de link staat daarin. Zoek eventueel op 'Teams' in je mailbox. Kom je er niet uit? Bel ons even op " + SUPPORT + ", dan sturen we je de link direct." },
      ...
      { q: "Ik moet inloggen of een code invullen, maar dat lukt niet.", a: "Afhankelijk van de instellingen vraagt Teams soms om in te loggen of om een eenmalige code die naar je e-mail wordt gestuurd. Vul die code in en je bent binnen. Lukt het niet? Vul dan gewoon je naam in als gast, of bel ons op " + SUPPORT + "." },
    ],
    audio: [
        ...
        <div className="max-w-content mx-auto px-8 md:px-16 lg:px-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 items-end mt-6">
            <div className="max-w-[640px]">
              ...
              >
                Loopt er iets vast? Rustig — hier vind je snel het antwoord.
              </h1>
              <p className="text-white/60 text-base leading-relaxed">
                Kies je probleem (link, geluid, beeld of overig), of gebruik de zoekbalk.
                Weet je welk platform je gebruikt? Kies de tool voor de exacte stappen.
              </p>
            </div>
