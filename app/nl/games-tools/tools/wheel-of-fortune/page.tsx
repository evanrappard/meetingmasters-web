...
export const metadata: Metadata = {
  openGraph: { images: ogBeeld(deelBeeld("/games-tools/tools/wheel-of-fortune")!, "Iemand houdt een lijst omhoog met deelnemers en speelkaarten — Games & Tools van MeetingMasters") },
