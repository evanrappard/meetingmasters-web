/** Taalloze data en Nederlandse teksten van Games & Tools. */
...
export const NL = {
  ...
  games: {
    titel: "Spellen die groepen samenbrengen.",
    onder:
      "Online games waarin je team samenwerkt, overlegt en samen iets voor elkaar krijgt — speelklaar of helemaal afgestemd op je thema.",
    items: games,
  },
  ravenhack: {
  ...
  tools: {
    titel: "Gratis tools voor levendige meetings.",
    onder:
      "Kleine hulpmiddelen die je meeting een stuk levendiger maken. Ze zijn gratis en direct te gebruiken: je opent de tool in je browser en deelt je scherm — verder hoef je niets te installeren.",
    open: "Open tool →",
    items: tools,
  },
  voorJeBegint: {
