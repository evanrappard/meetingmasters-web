/**
 * De Engelse teksten van de drie subpagina's onder Virtueel Kantoor:
 * een zaaltje boeken, een kantoor huren, en Kantoor + Cultuur.
 *
 * "Kantoor + Cultuur" wordt "Office + Culture" — dat is de naam van het
 * traject en blijft dus herkenbaar in beide talen.
 */
...
export const ZAALTJE_EN = {
  ...
  wat: {
    kicker: "The room",
    titel: "A furnished space, ready to use.",
    body1: "Sometimes, for a different kind of meeting with a small group, you want an online place that works better than a grid of squares. Not a whole office, not a project, and no appetite for setting anything up yourself.",
    body2: "Book a furnished room for up to 12 people. You step in, it works, and we stay in the background. The easiest way to feel how meeting online can also be.",
  },
  ...
  locaties: {
    ...
    items: [
      ...
      { title: "A day in the woods", alt: "Virtual woodland circle with tree stumps in the green" },
      { title: "Off-site", alt: "Quiet space with plenty of green — a place to reflect" },
      { title: "Creative space", alt: "Virtual gallery with colourful art and a whiteboard" },
      { title: "Reflection", alt: "Benches in a flowering heath under a blue sky" },
      { title: "Working session", alt: "Virtual meeting room with a MeetingMasters screen" },
    ],
  },

  meer: {
    kicker: "Want more?",
    titel: "From a room to an office of your own.",
    huren: {
      title: "Rent a ready-made office",
      body: "A permanent, living place where you simply run into each other — by the month or by the year.",
      cta: "More about renting →",
    },
    cultuur: {
...
export const HUREN_EN = {
  metaTitle: "Rent a virtual office | MeetingMasters",
  metaDescription:
    "Rent a furnished, living virtual office and move straight in — by the month or by the year. Including technical support and onboarding. Built in SpatialChat.",

  hero: {
    titel: "Rent an online office, ready to move in.",
    intro: "The place where you run into each other again – ready to use.",
    cta: "Book a tour →",
    offerte: "Request a quote",
    beeldAlt: "A light, ready-to-use virtual office in SpatialChat with workspaces and a view over the city",
  },
  ...
  faqKop: "Frequently asked questions about renting an office",
  faq: [
    { q: "What does renting a virtual office involve?", a: "You rent a furnished, living online office in SpatialChat and move straight in — by the month or by the year. We build it, fit it out and manage it; you open the door. Including technical support and onboarding so that your team actually uses it." },
...
export const CULTUUR_EN = {
  metaTitle: "Office + Culture — a bespoke virtual office | MeetingMasters",
  metaDescription:
    "First the conversation about what you stand for and how you want to work together. Then we build the online office in which that culture comes to life.",

  hero: {
    titel: "Office + Culture: where you work, and how.",
    intro: "A new environment. A new impulse.",
    cta: "Book an introduction →",
    beeldAlt: "Floor plan of a bespoke virtual office, filled with a team working in it",
  },
