/** Taalloze data en Nederlandse teksten van Over ons. */
...
export const NL = {
  hero: {
    kicker: "Over ons",
    titel: "Als mensen samenkomen, ontstaat iets moois.",
    regel1: "We leren van elkaar. We versterken elkaar. We ontwikkelen.",
    regel2: "Maar dat gaat niet vanzelf.",
  },
  wieWeZijn: {
    kicker: "Wie we zijn",
    titel: "Meesters in online samenkomen.",
    body: "MeetingMasters is een full-service bureau voor bijzondere online bijeenkomsten. Sinds 2020 brengen we vernieuwing in meetings, events en thuiswerken — een jong, gespecialiseerd bureau, gebouwd op twintig jaar ervaring in strategie en participatie.",
  },
  drijft: {
    kicker: "Wat ons drijft",
    titel: "Alles draait om verbinding.",
    body: "Wij geloven dat menselijk contact de basis vormt van alle groei en ontwikkeling. Vanuit dit perspectief zetten wij ons in om organisaties veerkrachtiger te maken en de verbindende cultuur te verrijken.",
  },
  manifest: {
    kicker: "Ons manifest",
  ...
  mensen: {
    kicker: "De mensen",
    titel: "Mensen maken meetings.",
    body: "MeetingMasters heeft een kleine, ervaren backoffice, een ruim netwerk van partners en een stevige pool met hoogopgeleide Masters. We zijn continu in ontwikkeling. Samen maken we meer van meetings.",
    oprichter: "Oprichter",
    oprichterNaam: "Emilie van Rappard",
    oprichterBody: "Als ervaren merk- en participatiestrateeg begeleidt Emilie van Rappard nationaal en internationaal groepen om samen tot nieuwe richtingen te komen. Vanuit de principes van Genuine Contact en de methodologie van Liberating Structures zoekt ze naar de verbinding tussen mensen en organisaties. Onsite en online. In 2020 richtte ze MeetingMasters Online op.",
  ...
  rollen: {
    kicker: "Onze rollen",
    titel: "Wat wij doen — vooraf en op de dag zelf.",
    intro: "Van strategie tot concept. Van online meeting support tot evaluatie en vervolgstappen. Wij zoeken altijd naar maximale betrokkenheid om tot de beste resultaten te komen, en zetten scherp in op optimale inzet van íeders energie, tijd en budget.",
    vooraf: "Voor de bijeenkomst",
    voorafOnder: "Van de vraag achter de vraag tot een ruimte die klaarstaat.",
    tijdens: "Tijdens de bijeenkomst",
    tijdensOnder: "Afhankelijk van de bijeenkomst zetten we de juiste rollen in — voor een soepel verloop, echte interactie en deelnemers die zich op hun gemak voelen.",
    na: "De kracht van een bijeenkomst zit in het vervolg: vooraf bedacht, tijdens besproken, na afloop opgevolgd — met opnames, verslagen en een gesprek over hoe nu verder.",
    voorafItems: rolesVooraf,
