...
const useCases = [
  { icon: "🎓", title: "Trainingen", desc: "Deelnemers moeten opletten op begrippen, voorbeelden of gedrag. Bingo maakt passief luisteren actief." },
  ...
  { icon: "🤝", title: "Onboarding", desc: "Nieuwe medewerkers zoeken termen, namen en situaties in hun eerste weken. Verbindt onboarding met beleving." },
];
        ...
        <div className="max-w-content mx-auto px-8 md:px-16 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              >
                Luisteren omdat je iets wil vinden.
              </h2>
              ...
              <p className="text-[#545454] leading-relaxed mb-8">
                Wie vijf op een rij heeft, roept bingo. In het chat-venster, via de reacties,
                of gewoon hardop. Het effect? Deelnemers letten op — niet ondanks de meeting,
                maar vanwege de meeting.
              </p>
              <div className="flex flex-wrap gap-3">
