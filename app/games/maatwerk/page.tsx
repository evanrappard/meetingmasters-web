...
const formats = [
  {
    ...
    duur: "15 – 30 min",
    title: "Mini-game",
    desc: "Een compact spelelement binnen een groter programma. Zet in na een lange plenaire sessie, als energizer, of als overgang tussen twee onderdelen. Hoog effect, weinig tijd.",
  ...
  },
  {
    ...
    desc: "Een zelfstandig gameconcept met eigen verhaal, opbouw en ontknoping. Centerpiece van uw event of als standalone sessie. Uw merk, uw thema, uw boodschap.",
    examples: ["Branded escape room", "Simulatiespel", "Rollenspel met scenario", "Competitie met live scorebord"],
  },
  {
    icon: "🎓",
    duur: "Op maat",
    title: "Leer- en onboarding game",
    desc: "Games als drager van echte leerdoelen. Nieuwe medewerkers die de organisatie ontdekken. Medewerkers die beleid begrijpen. Kennis die blijft hangen.",
    examples: ["Onboarding adventure", "Compliance training", "Cultuuroverdracht", "Veiligheidsbewustzijn"],
  },
];

const process = [
  { n: "01", title: "Briefing", body: "U vertelt over uw doel, uw groep en uw context. Wij stellen de vragen die u nog niet gesteld heeft." },
  ...
  { n: "03", title: "Bouw & test", body: "We bouwen het spel, testen met een kleine groep en schaven bij tot het klopt." },
    ...
    <>
      ...
      <section className="bg-[#2D2D2D] py-20 md:py-28">
        <div className="max-w-content mx-auto px-8 md:px-16 lg:px-20">
          <Link href="/games" className="text-white/40 text-xs hover:text-white/70 transition-colors mb-8 inline-block">
            ← Games & Tools
          </Link>
        ...
        <div className="max-w-content mx-auto px-8 md:px-16 lg:px-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { title: "Trainingen", desc: "Kennis overdragen via een spel. Hoger rendement, meer retentie, minder weerstand." },
              ...
              { title: "Kick-off", desc: "Het jaar of project openen met iets dat mensen herinneren. Energie, richting en verbinding in één." },
            ].map((u) => (
