...
export const metadata: Metadata = {
  title: "Platform vergelijking | MeetingMasters Techniek",
  description:
...
const platforms = [
  {
    ...
    strengths: ["Geïntegreerd in Microsoft 365", "Geschikt voor kleine vaste teams", "Goed voor chat + vergaderen combineren"],
  ...
  },
  {
    ...
    strengths: ["Stabiel en breed bekend", "Sterk voor grote webinars (tot duizenden deelnemers)", "Goede break-out functionaliteit"],
    limits: ["Breakouts zijn willekeurig en geforceerd", "Netwerken voelt kunstmatig", "Geen ruimtelijkheid of bewegingsvrijheid", "Na afloop: scherm dicht, verbinding weg"],
    verdict: "Solide keuze voor webinars. Minder sterk als u échte interactie en verbinding wil.",
    color: "border-[#E8E8E8]",
  },
  {
    name: "Google Meet",
  ...
  },
  {
    ...
    strengths: [
      ...
      "Maatwerk achtergronden, kamers en sfeer",
      "SOC 2 Type II gecertificeerd",
    ],
    limits: ["Minder bekend dan Zoom of Teams", "Vraagt iets meer gewenning van deelnemers", "IT-afdeling moet goedkeuring geven voor nieuwe tool"],
    ...
    <>
      ...
      <section className="bg-[#2D2D2D] py-20 md:py-24">
        <div className="max-w-content mx-auto px-8 md:px-16 lg:px-20">
          ...
          <p className="text-[#EEBE3D] text-[10px] font-bold tracking-[0.2em] uppercase mb-5">Platform vergelijking</p>
          <h1
          ...
          <p className="text-white/65 text-base leading-relaxed max-w-[520px]">
            Zoom, Teams en Google Meet zijn prima tools voor wat ze bedoeld zijn. Maar voor
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <div>
              ...
              <p className="text-[#545454] leading-relaxed mb-5">
                ...
                breakout toewijzen, geen scherm afsluiten als het klaar is. Het voelt zoals
                aanwezig zijn voelt.
              </p>
              <p className="text-[#545454] leading-relaxed">
                Wij zijn officieel Dutch Channel Partner van SpatialChat. Dat betekent directe
