...
export const metadata: Metadata = {
  ...
  description:
    "Book an online meeting room, R@venHack or EscapeMasters. Let us know your preferred date and group size and we'll tell you quickly what's possible.",
  alternates: {
      ...
      intro={
        <>
          <p>
            ...
            tell us what you&rsquo;re after and when, and we&rsquo;ll let you know what&rsquo;s possible.
          </p>
          <p className="text-base">
            Not sure yet? Add what you have in mind and we&rsquo;ll suggest what fits.
          </p>
        </>
      }
      formulier="boeking"
