...
const ONGESORTEERD: BlogPostEN[] = [
  {
    ...
    "excerpt": "More and more employers are fixing the number of office days. But the argument is not about where people work — it is about cohesion. And nobody talks about that any more.",
    "dek": "At ABN AMRO there is a proposal to write office days into the collective labour agreement. Both sides want the same thing, and still the conversation is stuck. Because it is about the wrong subject.",
    "metaDescription": "Writing office days into a labour agreement: the means has become the end. The question is not where people work, but how they work together.",
    "readingMinutes": 6,
    "blocks": [
      {
        "type": "p",
        "text": "At ABN AMRO there is a proposal to write a minimum number of office days into the collective labour agreement. The negotiation is about where people work. But that is not what the argument is really about. Nor is it about productivity, whatever is claimed. And only indirectly about creativity or the capacity to innovate. The underlying pain being described is the loss of cohesion now that not everyone sits in the same place. As long as that stays a side issue rather than the main subject, everyone will keep talking past each other."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "The facts first. ABN AMRO wants the new agreement to require staff to spend at least half their working week in the office. The bank motivates this with better collaboration, more creativity and a clearer line between work and private life. Partly defensible. What stands out, though, is the route. Writing an obligation like that into a labour agreement is unusual, and it seems to close down the very thing it is after: more contact. The bank's current agreement leaves the choice to the conversation between employee and manager. What used to be a conversation now has to become an enforceable rule."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Even though it is rarely named as such, the worry about the organisation being hollowed out is real. A long-running American study in Science shows that more than half of people working from home feel less connected to colleagues. Those living alone are the most vulnerable. Younger staff have nobody they can just put a quick question to. Onboarding stutters, knowledge travels more slowly, the sense of us wears thin. If you carry final responsibility for an organisation, you cannot keep watching that happen."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "How does a conversation get stuck when both sides want the same thing? Because it is about the wrong subject. Attendance is the only lever you can count, check and put in writing. So leadership reaches for it, and steers on office days while it means belonging. Employees hear no concern, only distrust, and start talking about their freedom. Unions negotiate over it, and the moment something is negotiable it becomes currency. Two days in exchange for something else."
      },
      {
        "type": "p",
      ...
      {
        "type": "h2",
        "text": "The question is not where, but how"
      },
      {
        "type": "p",
        "text": "Cohesion does not come from attendance itself. In the offices of the past it came from everything that happened around it: the question across the desk, the chat by the machine, going over a difficult conversation together afterwards."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "A conversation like that produces insight, more understanding and a new direction: the starting point for a culture that shifts and connects. On top of that, it lets you make agreements that hold up far longer, so a sense of us is not only discussed but actually sticks."
      },
      {
        "type": "h2",
  ...
  },
  {
    ...
    "dek": "Most gatherings were not good before they went online. Online only made it more visible: the problem is rarely the medium, but the form and the design.",
    "metaDescription": "Meeting online is not a substitute for offline. The problem is rarely the medium, but the form. Here is how you design a gathering on purpose.",
    "readingMinutes": 4,
    "blocks": [
      {
        "type": "p",
        "text": "Most gatherings were not good before they went online. Online only made it more visible. The awkwardness, the drifting off, the lack of energy or focus: it was usually already there. The problem is rarely the medium. The problem is the form. And the design."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Comparing online and offline is a strange thing to do, really. We compare a physical gathering that has often been allowed to exist unquestioned for years with an online version that suddenly has to prove it is just as good. In doing so we forget how poorly many physical gatherings are set up. Long plenary sessions. One-way traffic. Barely any interaction. Vague goals. Nobody asking what this gathering is actually meant to produce."
      },
      {
        "type": "p",
        "text": "Offline has a head start because we are used to it. Not because it is better."
      },
      {
        "type": "p",
        "text": "Online takes that givenness away. Everything that does not add up becomes visible. Talk too long and you are looking at blank cameras. Leave no room for interaction and you lose people. Design no rhythm and you feel the energy drain. That is confronting. It is also valuable."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "Only then comes the medium. Sometimes that is offline. Sometimes hybrid. And very often online."
      },
      {
        "type": "p",
        "text": "For certain goals online is not a compromise but the better choice. Think of international groups. Of equality in conversation. Of lowering the threshold to speak up. Of speed and frequency. Of sustainability. Of focus."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "What we see time and again: most of it is solved by method. By making choices about formats. By building rhythm. By alternating between listening, thinking and doing. By involving people actively instead of letting them consume passively."
      },
      {
        "type": "p",
        "text": "Good online gatherings are rarely spontaneous. They are designed. So are good offline gatherings, for that matter — we have simply grown less strict about those."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "The difference is that online offers no escape routes. You cannot hide behind a venue, a stage or a long lunch break. If the design does not work, you feel it straight away."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "On top of that comes the platform. Not as a trick, but as context. The form you place people in shapes how they behave. That is true offline, and just as true online."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Humanity is not in the medium. It is in attention. In room to respond. In being seen and heard. In pace. In taking participants seriously."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "As long as we keep defending online against offline, we stay tense. We try to imitate what we know instead of using what is possible. The question is not: how do we make online as much like offline as we can? The question is: how do we design gatherings that do what they need to do? Sometimes that is offline. Sometimes online. Sometimes a clever combination. But always chosen on purpose."
      },
      {
        "type": "quote",
        "text": "Online made visible what was not working already. That is not a problem. That is an opportunity."
      }
    ]
  },
  {
    ...
    "dek": "The argument about home versus office moves back and forth like the tide. Time for a third way, where the point is not location but how much people actually work together.",
    "metaDescription": "Home or office? The debate keeps circling. Discover the third way: what counts is not where work happens, but how much people work together and are present.",
    "readingMinutes": 3,
    "blocks": [
      {
        "type": "p",
        "text": "Centralise. Decentralise. Centralise. Decentralise… It is a reassuring swell that moves through the organisational landscape like the tide. Looking for uniformity, control and economies of scale? Centralise. Turns out you need more autonomy and a faster response? Decentralise. Back and forth. Back and forth."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "What we need is a shared space where people are present even when there is no meeting. A digital working environment where colleagues run into each other, even when there is no direct reason to. Where you can drop in on a department, or work quietly alongside someone without an agenda getting involved."
      },
      {
        "type": "p",
        "text": "We use SpatialChat as our remote office: a virtual environment where you can work, have a chat or wander over to the virtual coffee corner. Where a conversation starts because you are near someone. Where you can ask a question without it turning into a meeting. Just online. Just working. Just present together."
      },
      {
        "type": "p",
        "text": "Once location stops being decisive and being together does not, you reach a different level. Then the question is no longer how many days somebody sits in the office. The question is how you build a culture in which people find each other faster. Where staff feel seen, wherever they work. Where your colleagues are the reason you log on in the morning."
      },
      {
        "type": "p",
  ...
  },
  {
    ...
    "excerpt": "Making contact online is a craft of its own. And that is good news, because far more is possible than most people think.",
    "dek": "A well-designed online session gets things done that would never work in a room. The grid of little square faces is only one way of meeting online, and the world beyond it is bigger than most people know.",
    ...
    "blocks": [
      ...
      {
        "type": "p",
        "text": "That may sound ambitious if your idea of online is mainly a grid of little square faces with the occasional screen share. There is broadcasting there, but not much sharing, and the bigger, longer or more delicate the session, the more that hurts. Yet the grid is only one way of meeting online. There are others, and the world beyond it is bigger than most people know."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "Those three together separate a session where people afterwards say \"I was there\" from one where they say \"that was worth my time\". And a screen asks more of that design than a room does, not less. There is more distraction, looking away costs nobody anything, and someone who withdraws is less likely to be noticed. Which is exactly why the design matters more."
      },
      {
        "type": "p",
        "text": "If you have people vote by walking to a green or a red area rather than clicking briefly, for instance, they stay far more alert. And if you leave room for small conversations spread around the space, you usually harvest more than you would in a plenary round."
      },
      {
        "type": "h2",
        "text": "For the things that matter, the standard is not enough"
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Offline, for a session like that you would book a venue, a chair, perhaps an events agency. Online, that same reflex ought to be standard, and increasingly it is. Not because you could not do it yourself, but because the session that matters deserves a different level of attention than the weekly catch-up."
      },
      {
        "type": "p",
      ...
      {
        "type": "h2",
        "text": "Meeting online has not stood still since 2020"
      },
      {
        "type": "p",
        "text": "There are spatial platforms where participants move themselves around and talk based on who is near them. There are formats that would not even be possible in a physical room. There are formats that make large groups feel small and personal."
      },
      {
        "type": "p",
        "text": "Whoever has online down has mastered more than a tool. They have found a way to genuinely bring scattered people together. And for more and more organisations, that is exactly what they need."
      },
      {
        "type": "p",
        "text": "PS. The examples above come from work in SpatialChat, a platform where participants move themselves through a space and talk based on proximity. Quite unlike Zoom, Teams or Google Meet. If anything, it is closest to how meeting in real life works. And that makes all the difference."
      }
    ]
  },
  {
    ...
    "dek": "Gamers keep friendships going entirely online. They hang around a virtual corner, they play, they chat, they are simply there. No agenda, no action points, no 'any questions?' Just being together, around a shared goal or a shared interest. A format we do very little with in organisations. Online, at least.",
    ...
    "blocks": [
      ...
      {
        "type": "p",
        "text": "Ask gamers how they keep their friendships going and you get an answer many managers would not recognise. They log in, they hang around somewhere, they talk a bit. Sometimes they play something, sometimes they do not. The point is not the activity. The point is being present."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Gamers solve that without thinking about it. They have a place they go to. Not for a specific purpose, but because it is their place. They wander around, they run into people, sometimes they talk at length, sometimes they wave and move on. The space is always there. The threshold to step in is low."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "The shift is subtle, but large. A meeting is something you attend. A place is somewhere you go. In a meeting the organiser decides when you are there and what you do. In a place you decide that yourself. That autonomy makes the difference. It is the difference between 'I have to be on that call at ten' and 'let me drop by and see who is around.'"
      },
      {
        "type": "p",
        "text": "In organisations that set up a virtual office, we see something change in how people deal with each other. Slowly the moments come back that you have missed since everyone started working from home. The chat in the corridor. The idea over coffee. The feeling of belonging somewhere, even on a day when you are not physically in the office."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "You do not need to bring people together more often. You need to give them a place they go to themselves. No place, no culture. Only meetings."
      }
    ],
  ...
  },
  {
    ...
    "blocks": [
      {
        "type": "p",
        "text": "Zoom, Teams or Meet: a tidy grid of square boxes, neatly side by side. Everyone the same size, everyone the same distance away, everyone equally quiet. You are forced into following along passively. Walking off, or having a quick one-to-one, is not an option. You are stuck. So is everybody else. And still we expect that setting to produce energy."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "In a physical space we feel it at once. A meeting room with a long table and a projector on the wall says: presentations happen here. A circle of loose chairs says: we are going to talk. A foyer with standing tables says: walk around, make contact. The layout decides what people do before anyone has said a word."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "In a grid everyone is equal. That sounds democratic, but the effect is the opposite. You see the same amount of everyone, and you are not really in contact with anyone. There is no near, no far. You cannot step aside with two people. You cannot use your body to show you want to be part of something. The only way to signal you are there is to unmute. And almost nobody does."
      },
      {
        "type": "p",
        "text": "Then there is the noise. In a grid every participant brings their own visual world. Your kitchen, your bookshelf, the cat, light that refuses to cooperate. No shared context, no common environment to give the conversation direction."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "There are online environments where you are not stuck in a box. Where you move through a shared space as a circle, decide for yourself where you go, step closer to someone or take a bit of distance instead. Where your voice softens as you walk further away, just as it does in real life."
      },
      {
        "type": "p",
      ...
      {
        "type": "h2",
        "text": "When a grid works and when it does not"
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "So when you are organising an online session for a larger group, do not let the starting point be which tool you use. The first question is: do I want people to sit and listen, or do I want them to move and talk to each other? That answer decides the shape. And the shape decides what happens."
      },
      {
        "type": "p",
        "text": "PS. We work with SpatialChat, an online environment built during the pandemic by someone who wanted to drink cocktails online with friends. Not meet, not present. Just be together, and walk away from a conversation when the energy has gone out of it. You can feel that origin in how it works. Curious? Book an introduction and we will show you."
      }
    ]
  },
  {
    ...
    "excerpt": "Frustration with technology is an underrated factor in online sessions. Anyone still recovering from a technical fight is not connecting with the content — involvement starts at the login, not at the first agenda item.",
    "dek": "Rage at technology that will not cooperate is one of the most underrated factors in online gatherings. The answer is not better kit, but more humanity.",
    "metaDescription": "System rage in online meetings blocks involvement. Why the answer is not better tech, but more humanity and real in-meeting service.",
    "readingMinutes": 4,
    "blocks": [
      {
        "type": "p",
        "text": "In 1993 Compaq made a commercial about talking to your computer. Hilarious, I thought at the time. The promise: you speak, and your words appear on the screen. The reality is different. Most of the time we spend talking to our computers is not because we are making clever use of voice input. We are swearing at technology. Just like in 1993."
      },
      {
        "type": "p",
        "text": "In this piece we look at what powerlessness does to involvement, and why the answer is not better kit or ever more advanced features, but more humanity."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "You are in an online meeting, you want to say something, and your microphone will not work. Or your camera freezes. Or you share your screen and everyone sees your inbox instead of your presentation. It takes two minutes to fix, sometimes five. Meanwhile the whole group waits and reads your email."
      },
      {
        "type": "p",
        "text": "That is not a small inconvenience. Rage at technology that will not cooperate is one of the most underrated factors in online gatherings. It sounds trivial, but the effect is large. Somebody who has just spent five minutes fighting their audio is not relaxed in the conversation. They are still simmering. They check out mentally before the content has even started."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "It works like a wall. As long as someone is busy with technology that will not do what it should, that person is not contributing to what is actually being discussed. And it is not only about the person with the problem. The whole group feels it. Discomfort creeps in, impatience, distraction. The energy leaks away before a single substantive word has been said."
      },
      {
        "type": "p",
        "text": "After years of meeting online you would expect this to be solved. It is not. The tools have got better, that is true. But the combination of different devices, networks, settings and updates means there is always somebody for whom something does not work. And the bigger the group, the bigger the odds. That frustration piles up. And you carry it into your next meeting."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "That means: when somebody is struggling with the technology, you take them aside. You fix it away from the group, so the whole room does not have to watch. When somebody arrives late, you catch them up on what has happened so far and only then bring them back to the group."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "But it goes further than buttons and settings. Most Meeting Masters understand the technology better than anyone. In the MeetingMaster Academy we also train on the personal approach and on dealing with people whose emotions are running high. What is behind someone's anger? What helps? What definitely does not? That is not tech support. That is service in the broadest sense. And yes, online."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "You do not organise involvement once the agenda begins. It starts the moment someone logs in. Do they feel welcome? Does everything work? Is there somebody to help when it does not? Or are you fiddling with your settings on your own while the rest have already started?"
      },
      {
        "type": "p",
        "text": "The difference is large. It is not in the technology, but in the energy people carry into a session. And that energy decides whether you get a good conversation or an hour of silence with the occasional question."
      },
      {
        "type": "p",
        "text": "As long as you leave the technology to your participants, you are not designing a gathering. You are organising a risk."
      }
    ],
  ...
  },
  {
    ...
    "excerpt": "AI is taking over the routine work. But the moment someone says 'hold on, I see this differently' and a conversation changes the whole direction? That is where machines fall short. It only happens when people genuinely meet.",
    ...
    "metaDescription": "AI takes over routine work, but that is precisely why working together grows in value. Why meetings with real human contact matter more than ever.",
    "readingMinutes": 2,
    "blocks": [
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "A machine writes the policy deck, sends the updates and checks the action list. But the moment somebody says \"hold on, I see this differently from you\" and a conversation starts that changes the whole direction? That is where a machine falls short. It only happens when people sit together and there is enough structure to have that conversation."
      },
      {
        "type": "p",
        "text": "Meetings are the moments where you think together, decide together, set direction together. They are also the moments where you feel how an organisation works. Or does not. Where you notice whether there is trust. Whether anyone dares say the plan is wrong. Where you arrive together at an insight nobody would have had alone."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "Most gatherings let that chance go. The form does not allow for it. An hour of watching slides and jolting awake at the closing \"is that all clear?\" is not collaboration. It is broadcasting. A recorded video would do the job just as well, better even, because then you choose when to watch."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "And there is the paradox. We worry that AI will replace people. At the same time we spend most of our shared hours on activities a machine does just as well: sharing information, running through updates, recording action points. But surely we have so much more to offer as people? The part that makes us human, and makes us successful together, is the part we bring the least."
      },
      {
        "type": "p",
        "text": "Perhaps that also explains why the fear of AI sits so deep. We sense that in the moments that matter, we are not working very humanly ourselves."
      },
      {
        "type": "h2",
  ...
  },
  {
    ...
    "dek": "Everyone knows the scene: a meeting with thirty people where three talk and the rest stay quiet. The problem is not the people, but the mismatch between the goal, the group and the approach.",
    ...
    "blocks": [
      ...
      {
        "type": "p",
        "text": "The problem is not the people. Nor the intention, which is genuine. The problem is the mismatch between what you want to achieve, who is in the room and how you go about it. In this piece we show where the line sits and what you can do about it."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "Put more than fifteen people together and you have a presentation. Or chaos. One of the two. This is not an opinion. This is group dynamics."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "The real problem is not group size in itself. You can have a wonderful, involved gathering with three hundred people. The problem is that we do not think about the sum of three things: what do we want to achieve? Who is in the room? And what kind of involvement are we after? That is what you pick a format for."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "You put thirty people in a meeting room and expect a good conversation. You open a Zoom call with fifty participants and ask: \"Any questions?\" Afterwards you say: involvement was low. Or: online does not work for this sort of thing. But it was not the people. And it was not the medium. It was that the format did not match what you were asking of the group."
      },
      {
        "type": "h2",
        "text": "What does work"
      ...
      {
        "type": "p",
        "text": "The basic principle is simple. Large groups do not work as large groups. They work as collections of small groups, provided you organise that."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Above that you need a facilitator. Someone who shares out the space, lets silences do their work and makes sure it is not only the fast thinkers and loud talkers who get heard. And you work in subgroups. You split up, let small groups work and bring the results back together."
      },
      {
        "type": "p",
        "text": "That sounds like something everyone already does, but it is skipped surprisingly often. Or it is done with break-out rooms where nobody knows what the point is."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "Online the line gets sharper still. In a video call with more than ten people you can no longer read faces. You miss the body language that in a room tells you who wants to respond, who is drifting off, who disagrees. You cannot talk over each other. And you can switch your camera off and answer email. The group does not notice, or pretends not to. That makes formats online not optional but necessary."
      },
      {
        "type": "p",
        "text": "And here it gets interesting. For simple assignments it is enough to put subgroups together and hand them a task. But for more complex questions, subjects you want to look at from several angles, you would rather do it differently. Then you want participants to decide for themselves where their contribution fits best. Because the output gets better when people feel genuinely involved in what they are working on."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "It always starts with: how do we turn this large group into a collection of small groups that get to work? That is facilitation. Not a chair announcing the programme. Someone who creates the conditions in which a group can do what it came together for."
      },
      {
        "type": "p",
  ...
  {
    "slug": "a-stick-to-beat-it-with",
    "nlSlug": "stok-om-mee-te-slaan",
    "title": "A stick to beat it with",
    "date": "March 4, 2026",
    "iso": "2026-03-04",
    "img": "/images/blog/stok-om-mee-te-slaan.webp",
    "imgAlt": "Illustration for the article 'A stick to beat it with' on meeting design",
    ...
    "blocks": [
      ...
      {
        "type": "p",
        "text": "The problem is not the medium. The problem is that we treat special gatherings as large versions of ordinary meetings. More people, more slides, a longer day. But the same approach. That does not work offline either. Online it becomes painfully visible. Eight hours of slides is unbearable online. But was it actually any good offline? Or did people only get through it because there was no alternative?"
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "Online forces you to think about what you are actually trying to achieve. You cannot lean on the lunch, the drinks, the chance conversations in the corridor. You have to design involvement. And that turns out to be an opportunity. Because if you design a gathering with intent, if you think about the beginning, the middle and the end, if you make room for real interaction, then it works. Online, offline, hybrid. The medium is not the deciding factor."
      },
      {
        "type": "quote",
        "text": "The question is not: can we do this online? The question is: do we dare to design this gathering properly?"
      },
      {
        "type": "h2",
        "text": "The choice"
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "type": "p",
        "text": "Anyone who has competed at the Olympic Games stays an Olympian for life. That shared experience connects people, across countries and generations. But how do you keep that connection alive when you are scattered across the world?"
      },
      {
        "type": "p",
        "text": "The World Olympians Association, the alumni body for Olympians worldwide, was looking for a way to connect its athletes, including those who cannot travel to the Games. Work, distance, money: there are plenty of reasons to stay home. But staying home does not have to mean missing out."
      },
      {
        "type": "p",
      ...
      {
        "type": "h2",
        "text": "Why the WOA did not choose a video call"
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "At a physical OLY House you walk in, look around and see familiar faces. You join a group, catch a conversation, start talking to someone you had not met. Those chance encounters are what make it worthwhile."
      },
      {
        "type": "p",
        "text": "In a standard video call those moments do not exist. You are speaking or you are silent. There is no room to look around, no way to walk over to someone. The WOA wanted something closer to the real experience."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "e-OLY House works differently from a video call. It is built on three pillars."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "When you enter e-OLY House, you are standing on top of a mountain. In front of you is a ski lodge, with the Italian flag and snow-covered peaks behind it. You see people moving, groups forming, conversations starting. From here you can navigate to other spaces, or simply linger and see who is around. In an ordinary video call you are put in a box. Here you choose your own spot."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "During the Games, e-OLY House runs \"OLY@8\" every day: a show by Olympians, for Olympians. Every morning at eight and every evening at eight. In the morning show a host and a guest Olympian talk about what they are looking forward to that day. In the evening show they look back on it."
      },
      {
        "type": "p",
        "text": "But the real conversation only starts afterwards. After the show everyone moves through to the lounge. There you talk it over in small groups, with no moderator and no agenda. Exactly as you would linger after an event."
      },
      {
        "type": "h2",
      ...
      {
        "type": "p",
        "text": "That is what a meeting place does. It offers room for people to be, without anything having to happen. Real connection grows where there is room for chance and spontaneity."
      },
      {
        "type": "p",
      ...
      {
        "type": "p",
        "text": "Not everyone sits in the same place every day. Whether you have teams across locations, colleagues who often work from home, or volunteers you rarely see in person: the question is not whether you meet online, but how."
      },
      {
        "type": "p",
        "text": "A video call is a tool. An online meeting place is something else. Part of the difference is the technology, of course, but mostly it is in how you bring purpose, form and experience together."
      },
      {
        "type": "h2",
        "text": "Curious?"
      ...
      {
        "type": "p",
        "text": "Would you like to see what an online environment like this looks and feels like, for an event, a place to work together or a gathering that matters? Get in touch for a demo. We would be glad to show you what is possible. Because meeting online can be so much more than a square on your screen."
      }
    ],
